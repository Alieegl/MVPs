...
export const USERS: User[] = [
  { id: 'u1', name: 'Bernardo Director', role: UserRole.DIRECTOR, department: 'Dirección', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Carlo' },
  ...
  { id: 'u3', name: 'Carlos Jurídico', role: UserRole.REVIEWER, department: 'Jurídica', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Luis' },
